...
#endif // defined(GENERATING_DOCUMENTATION)
{
  public:
	...
	/// Copy constructor.
	ASIO_DECL
	any_completion_executor(const any_completion_executor &e) ASIO_NOEXCEPT;

#if defined(ASIO_HAS_MOVE) || defined(GENERATING_DOCUMENTATION)
	/// Move constructor.
	ASIO_DECL
	any_completion_executor(any_completion_executor &&e) ASIO_NOEXCEPT;
	...
	any_completion_executor(
		OtherAnyExecutor e,
		typename constraint<conditional<
	...
	any_completion_executor(
		Executor e,
		typename constraint<
			conditional<!is_same<Executor, any_completion_executor>::value &&
							!is_base_of<execution::detail::any_executor_base,
										Executor>::value,
	...
	operator=(const any_completion_executor &e) ASIO_NOEXCEPT;

#if defined(ASIO_HAS_MOVE) || defined(GENERATING_DOCUMENTATION)
	/// Move assignment operator.
	ASIO_DECL any_completion_executor &
	operator=(any_completion_executor &&e) ASIO_NOEXCEPT;
#endif // defined(ASIO_HAS_MOVE) || defined(GENERATING_DOCUMENTATION)
	...
	require(const Property &p,
			typename constraint<traits::require_member<
				const base_type &, const Property &>::is_valid>::type = 0) const
	{
	...
	prefer(const Property &p,
		   typename constraint<traits::prefer_member<
			   const base_type &, const Property &>::is_valid>::type = 0) const
	{
